...
<div class="content">
	<div class="content__albumOne" id="album">
		<div class="container">
			<h2 class="albumOne__heading">Gallery - Kiev</h2>
			...
			<div class="albumOne__breadNav">
				<ol class="breadcrumb albumOne_nav">
					...
					<li class="albumOne__item"><a href="#" class="albumOne__link albumOne__link_active">Kiev</a></li>
				</ol>
			</div>
			<div class="section">
				
				<div class="albumOne__photos">
					<? foreach($kiev as $photo => $num){ ?>
					<img class="albumOne__img col-sm-2" src="img/gallery/kiev/<?= $num?>.jpg" alt="">
					<? } ?>

	...
	<div class="content__top">
		<div class="container">
				...
				<div id="tourSlider" class="carousel slide tourSlider__slider" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="img/tours/streetArtTour/slider/4.png" alt="#" class="tourSlider__img">
						</div>

						<? foreach($tourSlider as $slide => $num){ ?>
						<div class="item ">
							<img src="img/tours/streetArtTour/slider/<?= $num?>.png" alt="#" class="tourSlider__img">
						</div>
						<? } ?>
			...
			<section class="tourHeader col-sm-7 col-xs-12">
				<h1 class="tourHeader__heading">street art tour</h1>
			...
			<section class="tourAbout__tourGallery" id="tourGallery">
				<div class="tourGallery">
					...
					<div class="tourGallery__item">
						<img src="img/tours/streetArtTour/photo/<?=$num?>.jpg" alt="" class="tourGallery__img">
					</div>
					<? } ?>

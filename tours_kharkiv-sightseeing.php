	...
	<div class="content__top">
		<div class="container">
				...
				<div id="tourSlider" class="carousel slide tourSlider__slider" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="img/tours/kharkiv-sightseeing/slider/4.png" alt="#" class="tourSlider__img">
						</div>

						<? foreach($tourSlider as $slide => $num){ ?>
						<div class="item ">
							<img src="img/tours/kharkiv-sightseeing/slider/<?= $num?>.png" alt="#" class="tourSlider__img">
						</div>
						<? } ?>
			...
			<section class="tourHeader col-sm-7 col-xs-12">
				<h1 class="tourHeader__heading">Kharkiv sightseeing</h1>
				<p class="tourHeader__comm">day tour by car</p>
				<p class="tourHeader__descr">This tour for people who want visit much places for one day.</p>
				<div class="tourHeader__duration">
					<i class="fa fa-clock-o tourHeader__fa" aria-hidden="true"></i>
					<span class="tourHeader__details"> Duration: 2 hours</span>
				</div>
	...
	<div class="content__tourAbout">
		<div class="container">
			<section class="tourAbout__descr">
				...
				<p class="tourAbout__text">National Opera of Ukraine, Golden Gate, St. Sophia Cathedral, a monument to Bogdan Khmelnitsky, Michael's Cathedral, monument to Princess Olga, Park Volodymyr Hill, beautiful views of Dniper, the monument to Prince Vladimir, Landscape alley, Historical Museum, Andrew's descent, St. Andrew's Church, Podol, Funicular, Kiev-Pechersk Lavra, The Park of eternal glory, museums war, the monument of the Motherland.</p>
			</section>
			<section class="tourAbout__tourGallery" id="tourGallery">
				<div class="tourGallery">
					...
					<div class="tourGallery__item">
						<img src="img/tours/kharkiv-sightseeing/photo/<?=$num?>.jpg" alt="" class="tourGallery__img">
					</div>
					<? } ?>

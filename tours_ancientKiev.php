	...
	<div class="content__top">
		<div class="container">
				...
				<div id="tourSlider" class="carousel slide tourSlider__slider" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="img/tours/ancientKiev/slider/4.png" alt="#" class="tourSlider__img">
						</div>

						<? foreach($tourSlider as $slide => $num){ ?>
						<div class="item ">
							<img src="img/tours/ancientKiev/slider/<?= $num?>.png" alt="#" class="tourSlider__img">
						</div>
						<? } ?>
			...
			<section class="tourHeader col-sm-7 col-xs-12">
				<h1 class="tourHeader__heading">ancient kiev</h1>
				<p class="tourHeader__comm">old town</p>
	...
	<div class="content__tourAbout">
		<div class="container">
			<section class="tourAbout__descr">
				...
				<p class="tourAbout__text">National Opera of Ukraine, Golden Gate, St. Sophia Cathedral, Michael's Cathedral, Park Volodymyr Hill, beautiful views of Dniper, the monument to Prince Vladimir, Landscape alley, Historical Museum, Andrew's descent, St. Andrew's Church, Podol, Funicular.</p>
			</section>
			<section class="tourAbout__tourGallery" id="tourGallery">
				<div class="tourGallery">
					...
					<div class="tourGallery__item">
						<img src="img/tours/ancientKiev/photo/<?=$num?>.jpg" alt="" class="tourGallery__img">
					</div>
					<? } ?>
